...
public class ShadowBox {
	...
	protected void update(Camera camera) {
		...
		toFar.scale(MasterRenderer.getShadowDistance());
	 ...
	 */
	public void calculateWidthsAndHeights(Camera camera) {
		farWidth = (float) (MasterRenderer.getShadowDistance() * Math.tan(Math.toRadians(camera.getFOV())));
		nearWidth = (float) (camera.getNearPlane()
				* Math.tan(Math.toRadians(camera.getFOV())));
