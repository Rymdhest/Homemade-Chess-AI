...
public class Fbo {
	...
	public void cleanUp() {
		...
		GL30.glDeleteRenderbuffers(colourBuffer0);
		GL11.glDeleteTextures(colourBuffer0);
		//GL30.glDeleteRenderbuffers(colourBuffer1);
		//GL11.glDeleteTextures(colourBuffer2);
		//GL30.glDeleteRenderbuffers(colourBuffer3);
		//GL11.glDeleteTextures(colourBuffer4);	
	}
	...
	public void bindFrameBuffer() {
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, colourBuffer0);
	...
	private void initialiseFrameBuffer(int type) {
		createFrameBuffer();
		colourBuffer0 = createTextureAttachment(GL30.GL_COLOR_ATTACHMENT0, GL30.GL_RGBA32F, GL11.GL_FLOAT, GL11.GL_RGBA, true);
	 ...
	 * FBO.
	 */
	public int createTextureAttachment(int attachement, int type, int type2, int type3,  boolean clamp) {
		int textureAttachment = GL11.glGenTextures();
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, textureAttachment);
		GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, type, width, height, 0, type3, type2,
				(ByteBuffer) null);
		...
		GL30.glFramebufferTexture2D(GL30.GL_FRAMEBUFFER, attachement, GL11.GL_TEXTURE_2D, textureAttachment,
				0);
