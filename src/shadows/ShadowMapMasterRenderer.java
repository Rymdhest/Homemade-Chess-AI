...
public class ShadowMapMasterRenderer {
	...
	public static int SHADOW_MAP_SIZE = 1024*4;
	public static float SHADOW_BIAS = 0.0008f;
	public static int pcfCount = 3;
	 ...
	 */
	public void render(Map<Model, List<ModelEntity>> entities, Entity sun) {
